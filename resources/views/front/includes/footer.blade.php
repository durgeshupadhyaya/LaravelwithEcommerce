        ...
        <div class="row footer-top-w3layouts">
            ...
            <div class="col-lg-3 footer-grid-w3ls">
                ...
                <div class="contact-info">
                    <h4>Location :</h4>
                    <p>0926k 4th block building, Hasanpur tole, Dhangadhi City,Nepal.</p>
                    <div class="phone">
                        <h4>Contact :</h4>
                        <p>Phone : +977 01 234 567</p>
                        <p>Email :
                            <a href="mailto:info@example.com">ecommerce@example.com</a>
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 footer-grid-w3ls">
                ...
                <ul class="links">
                    ...
                    <li>
                        <a href="{{ action('Front\PageController@show', $page->id) }}">{{ $page->name }}</a>
                    </li>
                    @endforeach
                </ul>
            </div>
...
<script src="{{ url('public/js/classie-search.js') }}"></script>
<script src="{{ url('public/js/demo1-search.js') }}"></script>
<!--//search jQuery-->
<!-- cart-js -->
...
<script src="{{ url('public/js/easy-responsive-tabs.js') }}"></script>
<script>
    $(document).ready(function () {
